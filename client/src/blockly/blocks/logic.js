 ...
 */
Blockly.Blocks.logic.HUE = "#43A047";
...
Blockly.Blocks['logic_operation'] = {
    ...
    typeblock: [{
            entry: Blockly.Msg.LOGIC_OPERATION_OR_TYPEBLOCK,
            fields: { 'OP': 'OR' }
        },
        {
...
Blockly.Blocks['logic_boolean'] = {
    ...
    typeblock: [{
            entry: Blockly.Msg.LOGIC_BOOLEAN_TRUE_TYPEBLOCK,
            fields: { 'BOOL': 'TRUE' }
        },
        {
...
Blockly.Blocks['logic_this'] = {
    ...
    init: function() {
        this.jsonInit({
            "message0": Blockly.Msg.LOGIC_THIS,
            "output": 'AndroidNonvisibleComponent',
            "colour": Blockly.Blocks.logic.HUE,
            "tooltip": Blockly.Msg.LOGIC_NULL_TOOLTIP,
            "helpUrl": Blockly.Msg.LOGIC_NULL_HELPURL
        });
    },
    typeblock: Blockly.Msg.LOGIC_THIS_TYPEBLOCK
};
